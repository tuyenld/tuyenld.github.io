---
title: Tự DIY màn hình cho Raspberry Pi
categories:
  - diy
tags:
  - RaspberryPi
...
## Xác định màn là LCD/LED và bo đèn nền tương ứng

### Sự khác biệt giữa LCD và LED
...
| Mạch đèn nền | Phải dùng bo cao áp LCD đa năng [1 bóng](https://shopee.vn/Bo-Cao-%C3%A1p-LCD-%C4%91a-n%C4%83ng-1-b%C3%B3ng-(Kh%C3%B4ng-b%E1%BA%A3o-h%C3%A0nh)-i.24781698.971003892) hoặc [2 bóng](https://shopee.vn/Cao-%C3%A1p-%C4%91a-n%C4%83ng-2-b%C3%B3ng-mi%E1%BB%87ng-l%E1%BB%9Bn-(Kh%C3%B4ng-b%E1%BA%A3o-h%C3%A0nh)-i.24781698.1042681705) tùy vào màn hình | Dùng cao áp LED này: [Cao áp LED đa năng LED driver (Không bảo hành)](https://shopee.vn/product/24781698/970956735/) <br> - Không dùng được cho cao áp Neon, chỉ dùng cho đèn LED <br> - [Hướng dẫn sử dụng - YTB lqv77](https://youtu.be/FccgQ3yzHfw) |
...
### Nhận biết LCD hay LED

Có 2 cách để nhận biết một màn hình là LED hay LCD:
1.  Tháo ra xem chân kết nối với đèn nền
2.  Tra datasheet

#### Xem chân kết nối với đèn nền

1. LCD 

![]({{ site.cloudinaryurl }}2020-09-30-diy-man-hinh-laptop-cu-raspberry/image6.png)

- https://youtu.be/RUnLlIcdhig
- Cáp kết nối với cao áp chỉ có 2 dây thường là LCD

2. LED 
![]({{ site.cloudinaryurl }}2020-09-30-diy-man-hinh-laptop-cu-raspberry/image9.png)

- [What is inside LCD Monitor-LCD Monitor Teardown](https://youtu.be/FPTScqyI_bQ)
- Cáp kết nối đèn nền có nhiều hơn 3 dây --> chắc chắn đây là LED (LCD chỉ có 2-3 dây)


#### Tra datasheet của màn hình

1. LCD

Ví dụ màn **LCD** [LP171WP4-TLR1 (LPLA103)](https://www.panelook.com/LP171WP4-TLR1_LG Display_17.1_LCM_parameter_5779.html)

![]({{ site.cloudinaryurl }}2020-09-30-diy-man-hinh-laptop-cu-raspberry/image1.png)

- CCFL: [Cold cathode fluorescent lamp](https://en.wikipedia.org/wiki/Cold_cathode_fluorescent_lamp) (thường gọi là đèn cao áp)

2. LED

Ví dụ màn **LED** [LM215WF4-TLG1](https://www.panelook.com/LM215WF4-TLG1_LG Display_21.5_LCM_overview_14788.html)

![]({{ site.cloudinaryurl }}2020-09-30-diy-man-hinh-laptop-cu-raspberry/image18.png)

- WLED: white light-emitting diode (đèn LED ánh sáng trắng)


## Tìm controller điều khiển màn hình

### Điện áp hoạt động của màn hình (3.3V/5V/12V)
...
#### 30 pin, 8 cặp tín hiệu, nguồn bên trái

[[lqv77- shopee\] Cáp LVDS 30 pin 8 cặp tín hiệu](https://shopee.vn/Cáp-LVDS-30-pin-8-cặp-tín-hiệu-i.24781698.970988464) 
![alt_text]({{ site.cloudinaryurl }}2020-09-30-diy-man-hinh-laptop-cu-raspberry/image13.png "image_tooltip")

#### 30 pin, 8 cặp tín hiệu, nguồn bên phải

![alt_text]({{ site.cloudinaryurl }}2020-09-30-diy-man-hinh-laptop-cu-raspberry/image19.png "image_tooltip") 
> datasheet [LP171WP4-TLR1](https://cdn.datasheetspdf.com/pdf-down/L/P/1/LP171WP4-TLR1_LG.pdf) 

![alt_text]({{ site.cloudinaryurl }}2020-09-30-diy-man-hinh-laptop-cu-raspberry/image20.png "image_tooltip") 
> Double 6 bit >> cần 8 cặp tín hiệu 

![alt_text]({{ site.cloudinaryurl }}2020-09-30-diy-man-hinh-laptop-cu-raspberry/image14.png "image_tooltip")  
> Chân số 1,2,3 là nguồn bên phải nên **LP171WP4-TLR1 dùng 8 cặp tín hiệu, nguồn bên phải**

#### 30 pin, 5 cặp, nguồn bên phải

[[lqv77 - Shopee\] Cáp 18.5 LVDS 5 cặp tín hiệu - nguồn bên phải - 1ch 8bit 30pin - FIX-30-D8](https://shopee.vn/Cáp-18.5-LVDS-5-cặp-tín-hiệu-nguồn-bên-phải-1ch-8bit-30pin-FIX-30-D8-i.24781698.975336704)
![alt_text]({{ site.cloudinaryurl }}2020-09-30-diy-man-hinh-laptop-cu-raspberry/image7.png "image_tooltip")  
> Áp dụng cho màn: [M185XW01](https://cdn.datasheetspdf.com/pdf-down/M/1/8/M185XW01-V6-AUO.pdf) 

![alt_text]({{ site.cloudinaryurl }}2020-09-30-diy-man-hinh-laptop-cu-raspberry/image3.png "image_tooltip") 
> Single 8 bit -> cần 5 cặp tín hiệu

![alt_text]({{ site.cloudinaryurl }}2020-09-30-diy-man-hinh-laptop-cu-raspberry/image4.png "image_tooltip") ![alt_text]({{ site.cloudinaryurl }}2020-09-30-diy-man-hinh-laptop-cu-raspberry/image2.png "image_tooltip")


## Một số loại controller trên thị trường
...
2. [BOARD TIVI LCD V59 có HDMI (NẠP FW TỰ ĐỘNG) ](https://linhkienst.com/products/board-tivi-lcd-v59-co-hdmi-nap-fw-tu-dong) [__Recommended__]
...
3. [M.RT2281.E5 vs MT561-MD V2.1 khi nào sử dụng bo nào ?](https://youtu.be/j0Y-oXyGT6I)
  - [MT561-MD V2.1](https://shopee.vn/MT561-MD-V2.1-bo-LCD-%C4%91a-n%C4%83ng-\(jumper-12V\)-i.24781698.975280421)(100k, muốn thay đổi độ phân giải chỉ cần cắm lại header, phù hợp để test nhanh)
  - [RT2281](https://shopee.vn/RT2281-bo-gi%E1%BA%A3i-m%C3%A3-LCD-%C4%91a-n%C4%83ng-c%C3%B3-DVI-VGA-i.24781698.1264995518) (150k, **ra màu đẹp hơn**, muốn thay đổi độ phân giải phải nạp lại, phù hợp làm màn hình thứ 2)
4. [NT68676 HDMI + DVI + VGA LCD Điều Khiển LP171WP4-TLR1 17" 1440X900](https://aliexpress.com/item/32910674061.html) [^fnAli] bao gồm :
    1. LCD Controller board (sử dụng cho màn LP171WP4(TL)(R1))
...
1. Màn hình PC, TV, v.v
2. Controller chạy với độ phân giải của màn hình (chú ý nguồn cấp LDVS lên màn hình 3.3V/5V/12V)
3. Điều khiển đèn nền (bo cao áp LCD (1, 2 hay 4 bóng) hay LED)
4. Cáp LVDS + điện áp cấp cho màn hình tưng ứng

Hình ảnh sau khi DIY
(Pending)

---

[^fnAli]: Gõ tên màn hình trực tiếp trên AliExpress, khi đó bộ controller đã được nạp sẵn firmware và đi kèm với bo đèn nền tương ứng.